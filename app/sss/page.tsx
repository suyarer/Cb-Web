...
export const metadata: Metadata = {
  ...
  description:
    'ClubBeans hakkında 12 net cevap: ClubBeans nedir, neden anti-platform, ücretsizlik, kimin için, kimlik doğrulama, nasıl indirilir, Trust Score, veri güvenliği, kulüp kurma, ücretli etkinlik ve daha fazlası.',
  openGraph: {
