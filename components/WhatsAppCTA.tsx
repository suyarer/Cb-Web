  ...
  return (
    ...
    >
      <a
        ...
        onClick={handleClick}
        className="group flex items-center justify-between gap-3 bg-[#25D366] hover:bg-[#1ebe5d] rounded-full pl-6 pr-5 py-4 transition-all no-underline shadow-[0_8px_30px_rgba(37,211,102,0.25)] hover:shadow-[0_12px_40px_rgba(37,211,102,0.4)]"
        aria-label="WhatsApp kanalını takip et"
      >
        <span className="flex items-center gap-3">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-6 h-6 text-midnight flex-shrink-0"
            aria-hidden
          >
          ...
          <span className="text-base font-bold text-midnight">
            ClubBeans Kanalı&apos;nı Takip Et
          </span>
        </span>
        <span className="text-midnight font-bold text-lg group-hover:translate-x-0.5 transition">
          →
        </span>
      </a>
