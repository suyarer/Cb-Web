...
export const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    a: 'Hayır. Bir dakikada kendi Club\'ını kurabilirsin. Dikey seç, isim ver, Bean aç — kabilen dolmaya başlar. Tek şart: TrustScore\'un 75\'te başlar, masaya oturduğunda yükselir.',
  },
  {
  ...
  },
  {
    ...
    a: 'Aşağıda hello@clubbeans.com\'a mail gönder. Lansmandan 2 hafta önce alfa grubuna, 1 hafta önce beta grubuna davet ederiz. Tek mail, tek link — spam yok.',
  },
  {
